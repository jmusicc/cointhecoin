...
injectUI = function () {
	...
	ctcUI += '<div style="width:100%;background:#000;background:rgba(0,0,0,0.5)"id="toolbar"><button id="roll">Roll</button><button id="setparams">Set Params</button></toolbar>';
	ctcUI += '</div>';
