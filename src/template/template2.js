...
injectUI = function () {
	...
	ctcUI += '<div class="ui-widget-header ui-corner-all" style="width:100%;"id="toolbar"><button id="startstop">Start/Stop</button><button id="roll">Roll</button><button id="setparams">Set Params</button></div>';
	ctcUI += '</div>';
	ctcUI += '<div id="bot" class="bot-tabs" style="width:100%;" class="container-fluid">';
	ctcUI += '<ul><li><a href="'+rootURL+'#bot-1">Basic</a></li>';
	ctcUI += '<li><a href="'+rootURL+'#bot-2">Win/Loss</a></li>';
	ctcUI += '<li><a href="'+rootURL+'#bot-3">Advanced</a></li></ul>';
...
setTimeout(injectUIEvents, 1500);
setTimeout(initClicks, 4000);
